...
t_btn_c_0:
	...
	; determine whether button_length was long enough
	lds r16, BUTTON_LENGTH
	cpi r16, 20 ; timer4: 10 ms. for 200 ms, length must be 20
	brsh dash
dot:
	ldi r16, 0
	sts DOTDASH_STATE, r16
	rjmp t4end
